...
def qb_in_table():
	...
	for stats in qb:
		...
		c.execute("INSERT INTO QuarterBacks(name,team,games,qbRating,completions,attempts,passingPercentage,passingYards,passYdsPerGame,passYdsPerAttempt,passTDs,interceptions,rushes,rushYds,rushYdsPerGame,rushYdsPerAttempt,rushTDs,sacks,ydsLost,fumbles,fumblesLost) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
